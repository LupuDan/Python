...
#     print("Числа, встречающиеся в обоих наборах без повторений:")
#     for element in sorted_common:
#         print(element)
...
def max_berry_count(a):
    ...
    for i in range(n):
        ...
        total_count = curr_bush + prev_bush + next_bush
...
result = max_berry_count(berries)
